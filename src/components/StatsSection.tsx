      ...
      <SectionContainer>
        <div className="flex flex-col items-center gap-3 text-center sm:gap-[15px] lg:relative lg:block lg:h-[449px]">
          <div
            ...
            style={{
              background:
                "linear-gradient(140deg, rgba(160, 35, 255, 4) 0%, rgba(15, 44, 83, 1) 100%)",
            }}
          >
            <div className="lg:pl-[57px]">
              <h2 className="text-[26px] font-light leading-[1.2] text-white sm:text-[32px] md:text-[36px] lg:max-w-[486px] lg:text-[41px] lg:leading-[51px]">
